...
export const departments: Department[] = [
  { id: "d1", name: "Cardiology", slug: "cardiology", icon: "HeartPulse", description: "Heart & vascular conditions, hypertension, chest pain.", doctorsCount: 1 },
  { id: "d2", name: "Dermatology", slug: "dermatology", icon: "Sparkles", description: "Skin, hair, and nail concerns.", doctorsCount: 1 },
  { id: "d3", name: "Neurology", slug: "neurology", icon: "Brain", description: "Migraine, stroke, seizures, neuropathy.", doctorsCount: 1 },
  { id: "d4", name: "Pediatrics", slug: "pediatrics", icon: "Baby", description: "Newborn and child health care.", doctorsCount: 0 },
  { id: "d5", name: "Orthopedics", slug: "orthopedics", icon: "Bone", description: "Bones, joints, fractures, sports injuries.", doctorsCount: 0 },
  { id: "d6", name: "Gynecology", slug: "gynecology", icon: "Flower2", description: "Women's health and reproductive care.", doctorsCount: 0 },
  { id: "d7", name: "Psychiatry", slug: "psychiatry", icon: "BrainCircuit", description: "Mental health, anxiety, depression.", doctorsCount: 0 },
  { id: "d8", name: "General Physician", slug: "general", icon: "Stethoscope", description: "Everyday care and first consultations.", doctorsCount: 0 },
  { id: "d9", name: "Dentistry", slug: "dentistry", icon: "Smile", description: "Dental checkups and oral care.", doctorsCount: 0 },
  { id: "d10", name: "ENT", slug: "ent", icon: "Ear", description: "Ear, nose, throat and sinus care.", doctorsCount: 0 },
  { id: "d11", name: "Ophthalmology", slug: "ophthalmology", icon: "Eye", description: "Vision, eye disease, laser correction.", doctorsCount: 0 },
  { id: "d12", name: "Endocrinology", slug: "endocrinology", icon: "Activity", description: "Diabetes, thyroid, hormonal disorders.", doctorsCount: 0 },
];
...
export const doctors: Doctor[] = names.map((n, i) => {
  ...
  return {
    ...
    hospital: ["Aga Khan Hospital", "Shifa International", "Liaquat National"][i % 3],
    clinic: ["Health Plus Clinic", "Prime Care", "Wellness Suites"][i % 3],
    consultationFee: [1500, 2000, 2500][i % 3],
...
export const appointments: Appointment[] = [
  ...
  { id: "a3", doctorId: "doc-2", doctorName: doctors[1].name, doctorPhoto: doctors[1].photo, specialization: "Neurology", patientId: "p1", patientName: "Ali Raza", date: new Date(Date.now() - 5*86400000).toISOString(), time: "11:00 AM", type: "video", status: "completed", reason: "Migraine review", fee: 1500 },
];

export const prescriptions: Prescription[] = [
  {
    id: "rx-1", appointmentId: "a3", doctorName: doctors[1].name, patientName: "Ali Raza", date: new Date().toISOString(),
    ...
    advice: "Rest, warm fluids, hydration. Follow up if symptoms persist beyond 3 days.",
  },
];
...
export const invoices: Invoice[] = [
  ...
  { id: "inv2", number: "INV-2025-0129", date: new Date(Date.now() - 5*86400000).toISOString(), amount: 1500, status: "paid", method: "Credit Card", description: "Video consultation — Dr. Bilal Ahmad" },
...
export const reviews: Review[] = doctors.flatMap((d, i) => [
  { id: `r${i}a`, doctorId: d.id, patientName: ["Sara N.", "Ahmed R.", "Hiba S."][i], rating: 5, comment: "Explained everything clearly and never rushed the consultation. Truly excellent care.", date: new Date(Date.now() - (i+1)*86400000).toISOString() },
  { id: `r${i}b`, doctorId: d.id, patientName: ["Imran F.", "Zoya H.", "Fahad T."][i], rating: 4, comment: "Great doctor, felt heard. Prescription was helpful and I recovered quickly.", date: new Date(Date.now() - (i+3)*86400000).toISOString() },
]);
...
export const blogPosts: BlogPost[] = [
  ...
  { id: "b3", slug: "migraine-management", title: "Migraine management: what actually works", excerpt: "Evidence-based strategies from a practicing neurologist.", cover: "https://images.unsplash.com/photo-1584515933487-779824d29309?w=1200&h=800&fit=crop", author: doctors[1].name, authorRole: "Neurologist", date: new Date(Date.now() - 7*86400000).toISOString(), readMinutes: 4, category: "Neurology", content: "Full article content..." },
];

// Mutable so bookings can push doctor-scoped notifications at runtime.
export const notifications: NotificationItem[] = [
  { id: "n1", title: "Appointment confirmed", body: "Your video consultation with Dr. Ayesha Khan is tomorrow at 10:30 AM.", time: "2h ago", read: false, kind: "appointment", targetRole: "patient", targetPatientId: "p1" },
  { id: "n2", title: "New message from Dr. Sana Malik", body: "Please share a clearer photo of the affected area.", time: "5h ago", read: false, kind: "message", targetRole: "patient", targetPatientId: "p1" },
  { id: "n3", title: "Payment received", body: "Invoice INV-2025-0142 for PKR 2,500 has been paid.", time: "1d ago", read: true, kind: "payment", targetRole: "patient", targetPatientId: "p1" },
  { id: "n4", title: "New patient booking", body: "Ali Raza booked a video consultation for tomorrow at 10:30 AM.", time: "2h ago", read: false, kind: "appointment", targetRole: "doctor", targetDoctorId: "doc-1" },
];

export const chatThreads: ChatThread[] = doctors.map((d, i) => ({
  id: `t${i+1}`,
  peerName: d.name,
  peerRole: "doctor",
  peerAvatar: d.photo,
  lastMessage: ["Please share your latest report.", "Take one tablet after each meal.", "How are you feeling today?"][i],
  lastTime: ["Just now", "12m", "1h"][i],
  unread: [2, 0, 1][i],
  online: i % 2 === 0,
}));
